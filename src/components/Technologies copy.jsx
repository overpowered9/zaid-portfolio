...
import flutter from "../assets/tech/flutter-svgrepo-com.svg";
import github from "../assets/tech/github-svgrepo-com.svg";
import matlab from "../assets/tech/matlab-svgrepo-com.svg";
import micsql from "../assets/tech/microsoft-sql-server-logo-svgrepo-com.svg";
import mongodb from "../assets/tech/mongodb-logo-svgrepo-com.svg";
import mysql from "../assets/tech/mysql-logo-svgrepo-com.svg";
import postgresql from "../assets/tech/postgresql-svgrepo-com.svg";
import wordpress from "../assets/tech/wordpress-svgrepo-com.svg";
import python from "../assets/tech/python-3-logo-svgrepo-com.svg";

function Technologies2() {
  const technologies = [
    <img src={nodejs} alt="nodelogo" />,
    <img src={flutter} alt="flutterlogo" />,
    <img src={github} alt="githublogo" />,
    <img src={matlab} alt="matlablogo" />,
    <img src={micsql} alt="micsqllogo" />,
      ...
      <div className="max-w-3xl mx-auto px-5 mt-28">
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-10 mt-2 md:justify-around">
            <div className="text-gray-400 transform transition duration-500 ease-in-out hover:scale-110 ">
              <svg
            ...
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="text-gray-400 transform transition duration-500 ease-in-out hover:scale-110 "
              >
                {tech}
              </div>
            ))}
