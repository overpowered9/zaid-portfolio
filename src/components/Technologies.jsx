      ...
      <div class="max-w-3xl mx-auto px-5 mt-28">
        <div class="flex flex-col justify-center">
          <div class="text-center">
            <h2 class="font-semibold text-3xl">Technologies & Tools</h2>
          ...
          <div class="flex flex-wrap items-center justify-center gap-10 mt-2 md:justify-around">
            <div class="text-gray-400 transform transition duration-500 ease-in-out hover:scale-110 ">
              <svg
            ...
            <div class="text-gray-400 transform transition duration-500 ease-in-out hover:scale-110 ">
              <img src={micsql} alt="microsoft sql" />
            </div>
            <div class="text-gray-400 transform transition duration-500 ease-in-out hover:scale-110 ">
